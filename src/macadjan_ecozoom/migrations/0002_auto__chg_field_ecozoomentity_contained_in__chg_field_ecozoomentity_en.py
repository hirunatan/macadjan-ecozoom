...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EcozoomEntity.contained_in'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'contained_in_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['macadjan_ecozoom.EcozoomEntity'], null=True, on_delete=models.SET_NULL))

        # Changing field 'EcozoomEntity.entity_type'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'entity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['macadjan.EntityType']))

        # Changing field 'EcozoomEntity.main_subcategory'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'main_subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['macadjan.SubCategory']))

        # Changing field 'EcozoomEntity.map_source'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'map_source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['macadjan_ecozoom.MapSource']))

    def backwards(self, orm):

        # Changing field 'EcozoomEntity.contained_in'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'contained_in_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['macadjan_ecozoom.EcozoomEntity'], null=True))

        # Changing field 'EcozoomEntity.entity_type'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'entity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['macadjan.EntityType']))

        # Changing field 'EcozoomEntity.main_subcategory'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'main_subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['macadjan.SubCategory']))

        # Changing field 'EcozoomEntity.map_source'
        db.alter_column(u'macadjan_ecozoom_ecozoomentity', 'map_source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['macadjan_ecozoom.MapSource']))
    ...
    models = {
        ...
        u'macadjan_ecozoom.ecozoomentity': {
            ...
            'map_source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entities'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['macadjan_ecozoom.MapSource']"}),
