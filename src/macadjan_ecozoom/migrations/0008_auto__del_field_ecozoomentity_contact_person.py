...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EcozoomEntity.contact_person'
        db.delete_column(u'macadjan_ecozoom_ecozoomentity', 'contact_person')


    def backwards(self, orm):
        # Adding field 'EcozoomEntity.contact_person'
        db.add_column(u'macadjan_ecozoom_ecozoomentity', 'contact_person',
