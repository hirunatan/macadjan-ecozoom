...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntityProposal.contact_person'
        db.delete_column(u'macadjan_form_entityproposal', 'contact_person')


    def backwards(self, orm):
        # Adding field 'EntityProposal.contact_person'
        db.add_column(u'macadjan_form_entityproposal', 'contact_person',
