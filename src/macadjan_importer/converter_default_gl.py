...
class EntityConverterDefault(EntityConverter):
    ...
    def initialize(self, archive):
        archive.configure(_(u'Nome / Nombre'), _(u'Categorías'))
        ...
        needed_columns = set((
            ...
            _(u'C.P.'),
            _(u'Poboación / Población'),
            _(u'Provincia'),
            _(u'Zona'),
            _(u'Latitude / Latitud'),
            _(u'Lonxitude / Longitud'),
            _(u'Teléfono 1'),
            _(u'Teléfono 2'),
            _(u'Fax'),
            ...
            _(u'Obxetivo como entidade / Objetivo como entidad'),
            _(u'Finanzas'),
            _(u'Valores sociais e medioambientais / Valores sociales y medioambientales'),
            _(u'Forma de aceso / acceso'),
            _(u'Redes das que forma parte / Redes de las que forma parte'),
            _(u'Outras entidades coas que colabora / Otras entidades con las que colabora'),
            _(u'Proxectos en marcha / Proyectos en marcha'),
            _(u'Necesidades'),
            _(u'Ofrecemientos / Ofrecimientos'),
            _(u'Información adicional'),
            _(u'Data da última actualización / Fecha de la última actualización'),
        ))
    ...
    def get_slug_from_item(self, item):
        ...
        '''
        return slugify(item[_(u'Nome / Nombre')])
    ...
    def load_entity_from_item(self, entity, item):
        ...
        entity.name = item[_(u'Nome / Nombre')]
        entity.slug = slugify(item[_(u'Nome / Nombre')])
        entity.alias = u''
        entity.summary = item[_(u'Resume / Resumen')]
        entity.is_container = False
        entity.contained_in = None
        entity.address_1 = item[_(u'Enderezo (rúa e nº) / Dirección (calle y nº)')]
        entity.address_2 = item[_(u'Enderezo (resto) / Dirección (resto)')]
        entity.zipcode = item[_(u'C.P.')]
        entity.city = item[_(u'Poboación / Población')]
        entity.province = item[_(u'Provincia')]
        entity.country = 'España'
        entity.zone = item[_(u'Zona')]
        lat_str = item.get(_(u'Latitude / Latitud '), '')
        if lat_str:
            try:
        ...
        long_str = item.get(_(u'Lonxitude / Longitud'), '')
        if long_str:
            try:
        ...
        entity.legal_form = item[_(u'Forma xurídica / jurídica')]
        entity.description = item[_(u'Descrición xeral / Descripción general')]
        entity.goals = item[_(u'Obxetivo como entidade / Objetivo como entidad')]
        entity.finances = item[_(u'Finanzas')]
        entity.social_values = item[_(u'Valores sociais e medioambientais / Valores sociales y medioambientales')]
        entity.how_to_access = item[_(u'Forma de aceso / acceso')]
        entity.networks_member = item[_(u'Redes das que forma parte / Redes de las que forma parte')]
        entity.networks_works_with = item[_(u'Outras entidades coas que colabora / Otras entidades con las que colabora')]
        entity.ongoing_projects = item[_(u'Proxectos en marcha / Proyectos en marcha')]
        entity.needs = item[_(u'Necesidades')]
        entity.offerings = item[_(u'Ofrecemientos / Ofrecimientos')]
        entity.additional_info = item[_(u'Información adicional')]
        modification_date_str = item[_(u'Data da última actualización / Fecha de la última actualización')]
